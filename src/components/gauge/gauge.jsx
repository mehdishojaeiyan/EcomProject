  ...
  return (
    <>
      <div className="gaugeBigbox p-5">
        ...
        <span style={{ fontSize: "3em" ,fontWeight:'bolder'}}>{data.current_price} </span>
        <span style={{ fontSize: "2em" ,fontWeight:'bolder',color: data.price_change_24h >= 0 ? 'green' : 'red'}}> {data.price_change_24h.toFixed(2)}</span>
    <div className="mt-5">
      <GaugeChart/>
    </div>
        <p className="h2 p-3 mt-5">Metric</p>
